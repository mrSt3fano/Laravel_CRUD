...
Route::middleware('auth')->group(function () {
    ...
    Route::view( 'gerencia' , 'Personalizado.superAdmin' )
    ->middleware( [ /* 'verified' */'MDsuperadmin' ] )->name('gerenciaName');
    Route::view( 'administrador' , 'Personalizado.admin' )
    ->middleware( [ /* 'verified' */ 'MDadmin'])->name('administradorName');

    Route::get('/profile', [ProfileController::class, 'edit'])->name('profile.edit');
    Route::patch('/profile', [ProfileController::class, 'update'])->name('profile.update');
    Route::delete('/profile', [ProfileController::class, 'destroy'])->name('profile.destroy');

    Route::get('/productos', [ProductoController::class, 'index'])->name('usuarioName');
